<?php
	...
	$destination_folder		= 'uploads/'; //upload directory ends with / (slash) and directory should exists, otherwise error will occure
	...
	if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest')
	{
		...
		if($image_res)
		{
			...
			if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
			{
				...
				echo '<img src="'.$destination_folder.$thumb_prefix . $new_file_name.'" alt="Thumbnail">';
				echo '<br />';
	...
	{
		echo "No Post Request or AJAX request Found.";
	}
?>
